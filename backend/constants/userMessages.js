...
module.exports = {
  ...
  DUPLICATED_BOOK: 'кажется, ты уже читаешь эту книгу. если это не так, напиши, пожалуйста, в поддержку: @shellllllf 🤖',
  BOOK_NOT_MARKED_AS_RETURNED_1: 'кажется, ты забыл:а отметить, что сдал:а книгу:\n\n',
  BOOK_NOT_MARKED_AS_RETURNED_2: 'если что-то пошло не так, напиши, пожалуйста, в поддержку: @shellllllf 🤖',
  ...
  HOW_TO_RETURN: 'чтобы вернуть книгу, поставь её на полку shell(f), а потом нажми кнопку «вернуть книгу» из меню 🤝',
